...
# ---------------------------------------------------------------------------
# 1) Pairing/bonding: deliver Security Manager events and gate Just Works.
#    The native bt_hid module defaults to pairing LOCKED. Existing bonded
#    devices can re-encrypt normally; a new Just Works pairing is only accepted
#    while Mercury Remote explicitly opens a pairing window.
# ---------------------------------------------------------------------------
...
patches = (
    ("pairing gate", anchor_1, replace_1),
...
print("Applied BLE pairing gate + native BTstack HIDS/multi-host hooks to", path)
